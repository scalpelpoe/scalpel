export const CHANGELOG: { version: string; notes: string[] }[] = [
  {
    ...
    notes: [
      ...
      'Plugin SDK: added Button, TextInput, Textarea, Slider, Label primitives and forwarded RemoveButton, ExternalLinkButton, LeagueDropdown, SettingSelectBox, SettingToggleBox, StepInput, HotkeyRecorder, HotkeyField components. Also forwarded ItemChip and getItemIcon via a globalThis bridge so plugins can render items with the same icon resolution Scalpel uses.',
