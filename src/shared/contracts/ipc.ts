...
export const IPC_CHANNELS = {
  ...
  PLUGINS: {
    ...
    UNINSTALL_UNPACKED: 'plugins:uninstall-unpacked',
    RESTART_REQUIRED: 'plugins:restart-required',
    ...
    DEV_INSTALLED_EVENT: 'plugin-dev-installed',
    DEV_UPDATED_EVENT: 'plugin-dev-updated',
    DEV_UNINSTALLED_EVENT: 'plugin-dev-uninstalled',
